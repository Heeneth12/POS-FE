...
import { Clock, CheckCircle, XCircle, ChefHat, Package, DollarSign, TrendingUp } from 'lucide-react';
...
const Dashboard: React.FC = () => {
  ...
  const orders: OrderItem[] = [
    {
      ...
      table: 'Table 03',
      items: [
        { name: 'Cheese Burger', price: 12.00 },
    ...
    },
    {
      ...
      items: [
        { name: 'Cheese Burger', price: 12.00 },
        { name: 'Salad with Sesame', price: 16.00 }
      ],
      total: 28.00,
      status: 'cooking'
    },
    {
      ...
      table: 'Takeaway',
      items: [
        { name: 'Special Sandwich Grill', price: 14.00 },
    ...
    },
    {
      ...
      items: [
        { name: 'Salad with Sesame', price: 16.00 },
        { name: 'Noodles with Chicken', price: 12.00 }
      ],
      total: 28.00,
      status: 'cooking'
    },
  ...
  const statusConfig = {
    ...
    cooking: { color: 'bg-orange-100 text-orange-800 border-orange-200', icon: ChefHat },
    ready: { color: 'bg-green-100 text-green-800 border-green-200', icon: Clock },
        ...
        <div className="p-6">
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center justify-center">
                    <div className={`inline-flex items-center px-3 py-2 rounded-lg text-sm font-medium border ${statusConfig[order.status].color}`}>
          ...
          {filteredOrders.length === 0 && (
            <div className="text-center py-12">
              ...
              <p className="text-gray-400">Try selecting a different status filter</p>
            </div>
          )}
        </div>
      </div>
